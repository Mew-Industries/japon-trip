...
- la suma de `nights` de todos los `destino` = total de noches del viaje (hoy 39).
...
- **Vuelos** (United, Polaris business; **ventana NUEVA, números/horarios TENTATIVOS a reconfirmar**): open jaw por Tokio — ida EZE→IAH→HND (sale BA **6/10**, llega Tokio **HANEDA/HND 8/10**); vuelta **NRT→LAX→IAH→EZE sale 16/11**, llega BA 17/11. Los números/horarios mostrados (UA818/UA7937 ida; UA33/UA2318/UA819 vuelta) son los de los tickets previos (ventana 28/9) y quedan **pendientes de reconfirmar** con los pasajes nuevos del 6/10 — solo las fechas de la ventana están firmes.
- **Estructura**: **39 noches**, **12 nodos numerados** (10 destinos + 2 nodos de día completo). Tokio está PARTIDO: 6 noches al llegar (parada 1, 8–14 oct) + 6 noches al final pre-vuelo (parada 12, 10–16 nov). El viaje termina de vuelta en Tokio para el vuelo del 16/11. **Sin norte (Hokkaido)** y **sin Hiroshima**; Osaka subió a 5 noches.
...
- **Secuencia**: 1.Tokio llegada (6n) · 2.Nikko (fullday) · 3.Kanazawa (2n) · 4.Shirakawa-go (fullday) · 5.Koyasan (2n) · 6.Kioto (6n) · 7.Osaka (5n) · 8.Fukuoka (3n) · 9.Busan+Gyeongju (3n) · 10.Seúl (4n) · 11.Hakone (2n) · 12.Tokio final (6n). Suma destinos = 6+2+2+6+5+3+3+4+2+6 = **39**.
- **Cambios (jun 2026)**: se sacó todo Hokkaido (Sapporo/Noboribetsu/Hakodate) e Hiroshima/Miyajima; Osaka pasó de 3n a 5n (+Kobe day trip); ventana de vuelo corrida a 6/10–17/11. Los lugares guardados de los nodos eliminados (Sapporo: Mt. Moiwa, Sapporo Art Museum, Moerenuma Park) pasaron a `orphanPlaces` como pines sueltos.
- **Silver Week** (~19–23 sep) cae ANTES del viaje (arranca 6/10) — el viaje la esquiva por completo.
- Estado: fechas de la ventana de vuelo firmes; números/horarios de vuelo concretos a reconfirmar.
