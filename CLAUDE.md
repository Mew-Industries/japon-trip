...
- **Secuencia**: 1.Tokio llegada (5n) · 2.Nikko (de paso) · 3.Tohoku (2n) · 4.Sapporo (2n) · 5.Kanazawa (2n) · 6.Shirakawa-go (de paso) · 7.Koyasan (1n) · 8.Kioto (6n) · 9.Osaka (5n) · 10.Fukuoka (3n) · 11.Busan+Gyeongju (3n) · 12.Seúl (4n) · 13.Hakone (2n) · 14.Tokio final (5n). Suma destinos = 5+2+2+2+1+6+5+3+3+4+2+5 = **40**.
