...
- **Secuencia**: 1.Tokio llegada (5n) · 2.Nikko (de paso) · 3.**Hiraizumi** (1n) · 4.**Ginzan Onsen** (1n) · 5.Sapporo (2n) · 6.Kanazawa (2n) · 7.Shirakawa-go (de paso) · 8.Kioto (6n) · 9.Koyasan (1n) · 10.Osaka (5n) · 11.Fukuoka (3n) · 12.Busan+Gyeongju (3n) · 13.Seúl (4n) · 14.Hakone (2n) · 15.Tokio final (5n). Suma destinos = 5+1+1+2+2+6+1+5+3+3+4+2+5 = **40**. **15 nodos** (13 destinos + 2 de paso). **Tramo norte = Hiraizumi + Ginzan** (reemplazó al nodo Tohoku-TBD, 2026-06-03): Hiraizumi (Iwate, base del paseo en bote por **Geibikei** + Chūson-ji dorado) noche 1, **Ginzan Onsen** (Yamagata, pueblo onsen de faroles Taisho) noche 2. Día 14 activo (Geibikei a la mañana + traslado de ~3h30 a Ginzan + onsen al atardecer). Desde Ginzan se va al aeropuerto de Sendai para el vuelo a Sapporo. **Koyasan va DESPUÉS de Kioto** (reorden 2026-06-02): Shirakawa-go (de paso) duerme en Kioto; Koyasan queda entre Kioto y Osaka (hops cortos), evitando el tramo Shirakawa→Koyasan de ~7h.
