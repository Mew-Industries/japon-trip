...
- **Estructura**: **40 noches**, **14 nodos numerados** (12 destinos + 2 nodos "de paso"). Tokio está PARTIDO: 5 noches al llegar (parada 1, 8–13 oct) + 6 noches al final pre-vuelo (parada 14, 11–17 nov, última noche 16/11; el 17 es día final pre-vuelo de la tarde). El viaje termina de vuelta en Tokio para el vuelo del 17/11 (llega BA 18/11). **Chain norte al arranque** (sin backtrack): Tokio → Nikko (de paso) → Sendai/Tohoku 1n → Sapporo 2n → vuelo a Komatsu → Kanazawa. Hokkaido en oct está templado (~17°/7°); Tohoku en pico de otoño (~fines oct). **Sin Hiroshima**; Osaka 5n; Koyasan 1n.
...
- **Secuencia**: 1.Tokio llegada (5n) · 2.Nikko (de paso) · 3.Sendai/Tohoku (1n) · 4.Sapporo (2n) · 5.Kanazawa (2n) · 6.Shirakawa-go (de paso) · 7.Koyasan (1n) · 8.Kioto (6n) · 9.Osaka (5n) · 10.Fukuoka (3n) · 11.Busan+Gyeongju (3n) · 12.Seúl (4n) · 13.Hakone (2n) · 14.Tokio final (6n). Suma destinos = 5+1+2+2+1+6+5+3+3+4+2+6 = **40**.
